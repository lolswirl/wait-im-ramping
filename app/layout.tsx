...
export const metadata: Metadata = {
  ...
  description: "a website full of tools used to help world of warcraft healers plan, visualize, and optimize their healing. :3",
  openGraph: {
    type: "website",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={typeof window !== "undefined" ? (localStorage.getItem('themeMode') || 'dark') : 'dark'}>
      <body>
        <ThemeProvider>
          <SpecProvider>
