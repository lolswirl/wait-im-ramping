...
const BUGS: Bug[] = [
    ...
    },
    {
        ...
        description: <>Baseline <SpellLink spell={TALENTS.ANCIENT_TEACHINGS} /> does not consistenly heal for 30% of the damage dealt. It is consistently higher on <SpellLink spell={SPELLS.TIGER_PALM} /> and <SpellLink spell={SPELLS.BLACKOUT_KICK} /> and is sometimes lower on <SpellLink spell={SPELLS.RISING_SUN_KICK} />/<SpellLink spell={SPELLS.RUSHING_WIND_KICK} /></>,
        lastBuildTested: "65769",
        status: STATUS.FIXED,
    },
    {
    ...
    },
    {
        ...
        description: <><SpellLink spell={TALENTS.GUST_OF_MIST}/> is still proccing on the target when <SpellLink spell={SPELLS.SHEILUNS_GIFT} /> is cast on them</>,
        lastBuildTested: "64228",
        tags: [TAGS.MASTERY],
        status: STATUS.FIXED,
    },
    ...
    },
    {
        ...
        description: <><SpellLink spell={TALENTS.SPIRITFONT} /> <SpellLink spell={SPELLS.SPIRITFONT_SOOTHING_MIST} /> sometimes does 32bit int max value amounts of positive/negative overheal</>,
    ...
    },
    {
        ...
        description: <><SpellLink spell={SPELLS.COALESCENCE} /> only works for <SpellLink spell={SPELLS.SHEILUNS_GIFT} />, <SpellLink spell={SPELLS.VIVIFY} /> functions as it did prior to the rework still</>,
        lastBuildTested: "64914",
        tags: [TAGS.MOH],
        status: STATUS.FIXED
    },
    ...
    },
    {
        ...
        description: <>Hotfix to <SpellLink spell={TALENTS.ANCIENT_TEACHINGS} /> healing on pre-armor damage values (physical abilities reducing actual damage dealt by 30% account for armor) was reverted at some point from Undermine {'->'} Live. The conversion now only happens on post-armor values.</>,
        lastBuildTested: "66220",
        logs: [
    ...
    },
    {
        ...
        severity: SEVERITY.HIGH,
        lastBuildTested: "66709",
        title: <>Yu'lon's <SpellLink spell={TALENTS.SOOTHING_BREATH} /> sometimes only ticks 6 times, instead of 7 + partial</>,
    },
    {
        spell: SPELLS.YULON,
        affectedSpells: [TALENTS.GIFT_OF_THE_CELESTIALS, TALENTS.SOOTHING_BREATH],
        severity: SEVERITY.HIGH,
        lastBuildTested: "66709",
        title: <>Will not channel <SpellLink spell={TALENTS.SOOTHING_BREATH} /> a second time occasionally</>,
    },
    {
