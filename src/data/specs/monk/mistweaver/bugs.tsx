...
const BUGS: Bug[] = [
    ...
    },
    {
        ...
        description: <>Baseline Ancient Teachings does not consistenly heal for 30% of the damage dealt. It is consistently higher on Tiger Palm and Blackout Kick and is sometimes lower on Rising Sun/Rushing Wind Kick</>,
        lastBuildTested: "65769",
        status: STATUS.FIXED,
    },
    {
        ...
        description: <>Jadefire stomp's graphic variation causes inconsistency in the number of targets hit when cast from the exact same position.</>,
        lastBuildTested: "65769",
    ...
    },
    {
        ...
        description: <>Jade Serpent Statue Soothing Mist healing does not apply aspect of harmony</>,
    ...
    },
    {
        ...
        description: <>Jade Serpent Statue's Soothing mist does not contribute vitality</>,
        lastBuildTested: "66220",
    },
    {
        ...
        description: <>With Rapid Diffusion Talented, Rising Sun Kick adds and removes several buff stacks in succession then consumed immediately and a Nature gets applied, consumed, and reapplied</>,
        tags: [TAGS.MOH],
        lastBuildTested: "66220",
    ...
    },
    {
        ...
        description: <>Misty Peaks Procs consume Physical and add a stack of Nature</>,
        tags: [TAGS.MOH],
        lastBuildTested: "66220",
    ...
    },
    {
        ...
        description: <>Hard Cast Enveloping Mist with Rapid diffusion procs 3 stacks of Nature. This is from Envelop apply and then the Rapid Diffusion Rem having travel time</>,
        tags: [TAGS.MOH],
        lastBuildTested: "66220",
    ...
    },
    {
        ...
        description: <>The '8% of Enveloping Mist' is calculated before haste is factored in and significatly reduces the cleaves value</>,
        lastBuildTested: "65769",
        tags: [TAGS.HASTE],
        status: STATUS.FIXED,
    },
    ...
    },
    {
        ...
        description: <>Can move freely without movement speed decrease by starting a new Soothing Mist channel while inside of one already (refreshing the buff). Replicated in 66220 by starting a new channel on a different target than the original.</>,
        lastBuildTested: "66220",
        status: STATUS.OPEN,
    ...
    },
    {
        ...
        description: <>If an existing Aspect of Harmony HoT is on a player (whether it be from AoH Withdraw or from Coalescence), and Vivify/Sheilun's Gift is casted on them, likely you going into the negatives of vitality stored, the incoming HoT value from Coalescence overrides the previous HoT amount instead of refreshing and adding the new amount on top of it. This causes the HoT to be signficantly diminished when dumping a large amount of Vitality into the HoT, then still casting Vivify/SG on the target.</>,
        tags: [TAGS.MOH],
        lastBuildTested: "66066",
        status: STATUS.FIXED,
    },
