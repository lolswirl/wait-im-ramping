...
import mistweaverBugsJson from '@data/specs/monk/mistweaver/bugs.json';
import { resolveBugs } from '@util/bugResolver';
...
const MISTWEAVER_MONK = attachGetters({
  ...
  bugs: resolveBugs(mistweaverBugsJson.bugs).concat(MONK_BUGS),
