      ...
      <CardContent>
        <Stack spacing={2}>
          ...
          <Typography variant="body1" paragraph align="left">
            ...
            understand your spells a bit better. i have a lot of ideas for future features,{" "}
            so feel free to reach out in my{" "}
            <Link href="https://discord.gg/ZU5rhXtbNd" target="_blank" rel="noopener noreferrer" color="#7289da" underline="hover">
              discord
            </Link>{" "}
            or during my{" "}
            <Link href="https://www.twitch.tv/lolswirl" target="_blank" rel="noopener noreferrer" color="#9147ff" underline="hover">
              twitch
            </Link>{" "}
            streams if you have any suggestions!
          </Typography>
          <Typography variant="body1" paragraph align="left">
            the website is built with react, typescript, and material ui{" "}
            — and made for anyone who enjoys healing and wants to make the most of it.
          </Typography>
        </Stack>
      </CardContent>
    </Card>
